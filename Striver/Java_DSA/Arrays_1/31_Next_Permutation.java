...
public class NextPermutation
{
    ...
    // If break point doesn't exist, array is in decreasing order, hence it is the last permuation so just reverse it
    // If break point exists, swap the smallest element greater than a[i] in right half with a[i]
    // After swapping, sort the elements after a[i]. But since we know, after breakpoint elements are in decreasing, so just reversing them will sort it
